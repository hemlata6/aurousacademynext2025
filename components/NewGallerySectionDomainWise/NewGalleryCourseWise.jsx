...
const NewGalleryCourseWise = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        setSelectedCourse({ id: 3658, title: 'Gallery' });
        setOriginalCourseId(3658);
        getMergedSchedules(3658, 0);
    }, []);
    ...
    const handleBackClick = () => {
        if (navigationStack.length > 1) {
            ...
            // Go back to root gallery content
            setNavigationStack([]);
            setSelectedCourse({ id: 3658, title: 'Gallery' });
            setOriginalCourseId(3658);
            getMergedSchedules(3658, 0);
    ...
    const handleOpenPreview = (item, e) => {
        ...
        // For images, open full-screen preview with slider
        if (item?.entityType === 'image') {
            ...
            if (imageUrl) {
                ...
                const imageList = selectedSceduleList?.filter(img => img?.entityType === 'image') || [];
                                                ...
                                                {item?.thumb || item?.logo ? (
                                                    ...
                                                    >
                                                        ...
                                                        {(item?.entityType === 'video' || item?.entityType === 'audio') && (
                                                            ...
                                                            >
                                                                {item?.entityType === 'video' ?
                                                                    <PlayCircleIcon sx={{ color: '#000', fontSize: 24 }} /> :
                                                                    <AudiotrackIcon sx={{ color: '#000', fontSize: 24 }} />
                                                                }
                                                            </Box>
                                                        )}
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {item?.entityType === 'folder' ? 'OPEN' : 'VIEW'}
                                                            </Typography>
                                                        </Box>
                                                    </Box>
                                                ) : (
...
export default NewGalleryCourseWise;
