...
const NEET12_1YRCRP = '/12TH 1-Year Classroom Program for NEET UG.webp';
const NEET12_1YRSAN = '/12TH 1-Year Sankalp Program for NEET UG.webp';
const planner = images.plannerIcon;
const practice = images.practice;
const chapterSolving = images.chapterSolving;

const Class12hNEETCourse = () => {
    ...
    // Program features with medical-themed gradients for Class 12th NEET
    ...
    const class11thCourses = [
        {
            id: 4,
            name: `1-Year Classroom Program for NEET-UG`,
            ...
            description2: `Introducing our 1-year Classroom Program, meticulously designed to
pave your path to excellence in the NEET UG examination. With a team
of highly experienced faculty, a personalized learning approach, and a
comprehensive curriculum, this program ensures that students receive
thorough preparation for this highly competitive medical entrance
test.`,
...
proven track record of successful students who have achieved their
...
field.`,
        ...
        {
            id: 5,
            name: `1-Year Sankalp Program for NEET-UG`,
...
export default Class12hNEETCourse;
