...
import FreeResourcesSection1 from '@/components/FreeResourcesSection/FreeResourcesSection1';
...
export default function FreeResourcesPageClient() {
  // const instId = 120;
