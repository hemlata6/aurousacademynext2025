...
import NewGallerySectionDomainWise from '@/components/NewGallerySectionDomainWise/GallerySectionDomainWise';
...
export default function GalleryPageDomainWise() {
  // const instId = 120;
